...
Google and GitHub OAuth are the two supported providers, plus enterprise SSO via Active Directory Federation Services for corporate tenants. The OAuth callback
