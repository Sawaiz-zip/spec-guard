...
todo-cli Pro is $8/month per seat and unlocks unlimited lists, priority support, and hosted backups. Team and Enterprise tiers include centralized billing and an admin console.
