...
Users can authenticate by signing a challenge with their Ethereum wallet. The service verifies the signature and issues a JWT bound to the wallet address.
